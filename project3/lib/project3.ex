defmodule Implementation do
  def chord(numNodes,numRequests) do
    ...
    if ans != 0 do
      val = ans/(numRequests * numNodes) #calculates the average number of hops per request
      IO.puts " "
      IO.puts " "
...
defmodule Main do
  ...
  defp parse_args(args) do
    {_, parameters, _} = OptionParser.parse(args,  strict: [limit: :integer])
      ...
      Implementation.chord(numNodes,numRequests) #calls the runner functions with arguments
    end
end
